  ...
  const fetchFittings = () => {
    apiClient.get('/fittings').then((res) => {
      ...
      const mapped = list.map((f) => ({
        ...
        dress_id: f.booking?.dress_id || f.dress_id,
        dress_2_id: f.booking?.dress_2_id || f.booking?.dress2?.id,
        dress_2_name: f.booking?.dress2?.name || f.booking?.dress_2?.name || f.dress_2_name || null,
        dress_3_id: f.booking?.dress_3_id || f.booking?.dress3?.id,
        dress_3_name: f.booking?.dress3?.name || f.booking?.dress_3?.name || f.dress_3_name || null,
        booking: f.booking,
