...
export default function DressesPage() {
  ...
  const handleAddDressSubmit = async (e) => {
    ...
    try {
      let dressId = null;
      if (editingDress) {
        const res = await apiClient.put(`/dresses/${editingDress.id}`, {
          name: newName,
                ...
                <div
                  ...
                  <div>
                    ...
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-[10px] font-black text-slate-800">{dress.name}</span>
                      <span className={`text-[8px] font-extrabold px-2 py-0.5 rounded-full border ${getStageColor(dress.current_stage)}`}>
                    ...
                    <div className="grid grid-cols-2 gap-2 text-[9px] font-extrabold text-slate-500 mb-3.5">
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <span>إيجار: {dress.rental_price.toLocaleString()} ج.م</span>
                      </div>
                      {dress.designer &&
                      <div className="col-span-2 text-[8.5px] text-slate-400 font-bold">
            ...
            <form onSubmit={handleAddDressSubmit} className="p-6 space-y-4 overflow-y-auto flex-grow text-right scrollbar-thin">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1">
                  ...
                  <>
                      ...
                      className="px-3 py-2 bg-indigo-50 border border-indigo-150 text-indigo-600 rounded-2xl text-[10px] font-bold hover:bg-indigo-100/50 transition-all flex-shrink-0 cursor-pointer">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div className="space-y-1">
                    <label className="text-xs font-extrabold text-slate-600">المقاس</label>
                    <input
                    type="text"
                    required
                    placeholder="M"
