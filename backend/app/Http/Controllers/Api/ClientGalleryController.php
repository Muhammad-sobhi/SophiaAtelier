...
class ClientGalleryController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        $validated = $request->validate([
            ...
            'image' => 'required|file|mimes:jpeg,png,jpg,webp,mp4,mov,webm,avi,m4v,3gp|max:51200',
    ...
    public function update(Request $request, ClientGallery $clientGallery): JsonResponse
    {
        $validated = $request->validate([
            ...
            'is_published' => 'nullable|boolean',
            'sort_order' => 'nullable|integer',
            'image' => 'nullable|file|mimes:jpeg,png,jpg,webp,mp4,mov,webm,avi,m4v,3gp|max:51200',
        ]);
